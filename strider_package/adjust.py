...
class StriderWalkIK():
    ...
    def update(self):
        ...
        jump_sec = 0.2;
        jump_wait = 0.2;
        const_jump_delay = 0.1;
        sequence_sec = 4;
        sequence_count = 0;

        sequence_full = sequence_sec * control_hz;
        jump_full= jump_sec * control_hz
        sequence_offset = [0] * 4
        sequence_offset[0] = 0;
        sequence_offset[1] = sequence_full / 2;
        sequence_offset[2] =  jump_full + const_jump_delay * sequence_full;
        sequence_offset[3] = sequence_full / 2 + jump_full + const_jump_delay * sequence_full;
